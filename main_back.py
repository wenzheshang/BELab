            ...
            try:
                ...
                if self.NegitiveP.isChecked() == True:
                    if BoundaryName.find('inlet') != -1:
                        ...
                        BoundaryV = self.boundary_TlineEdit.text().strip()
        ...
        def startSimulation_click():
            try:
                ...
                for exd in range(len(EXD['FM'])):
                    ...
                    if FluentName.find('RoomT') != -1:
                    ...
                    elif FluentName.find('outlet_massflow') != -1:
                        ...
                        dict_FMpassValue[toModelicaName] = float(mass_flow)#增加压差的值

                    elif FluentName.find('fluxes') != -1:
